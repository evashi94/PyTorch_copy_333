...
class Agent(object):
    def __init__(self, args, env_prototype, circuit_prototype):
        ...
        self.model_name_ite  = args.model_name_ite
    ...
    def _save_model(self, step, curr_reward=0.):
        ...
        #added this part myself to save model on every step(500)
        torch.save(self.circuit.state_dict(), self.model_name_ite + "_" +str(step)+".pth")
        self.logger.warning("Additional Model saved for the current iteration.")
